<template>
  <div class="project" v-loading="loading">
    ...
    <!-- 添加项目弹出层 -->
    <el-dialog title="创建项目" width="550px" custom-class="addCart" :visible.sync="addProjectStyl">
      <el-form :model="form">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="开始时间" :label-width="formLabelWidth">
              <el-date-picker v-model="form.startTime" type="date" placeholder="请选择开始时间"></el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="结束时间" :label-width="formLabelWidth">
              <el-date-picker v-model="form.endTime" type="date" placeholder="请选择结束时间"></el-date-picker>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <div class="projectMsg">
          <el-input
            ...
            v-model="form.nameEmail"
          ></el-input>
          <div class="productVideo">
            <div class="videos checkboxes">
              <span class="sp1">产品研发</span>
              <el-radio v-model="form.radio" label="1"></el-radio>
              <div v-for="item in form.persons" :key="item.name">
                <span>{{item.name}}</span>
                <el-checkbox v-model="checked"></el-checkbox>
              </div>
            </div>
            <div class="videos">
              <span class="sp2">测试</span>
              <el-radio v-model="form.radio" label="6"></el-radio>
            </div>
            <div class="videos">
              <span class="sp3">售后</span>
              <el-radio v-model="form.radio" label="9"></el-radio>
            </div>
...
export default {
  ...
  methods: {
    ...
    addProject() {
      ...
      this.getCompanylist({ id: this.companyid });
    },
    cartPage() {
        ...
        .then(
          res => {
            if (res.data.ret == "0") {
              ...
              this.form.persons = res.data.content;
            } else {
              this.$message({
